...
strip = 0
apps = {}
currentApp = 'Tug of War'
simIndex = 0
simArray = ['Painting', 'tictactoe', 'chess', 'animation', 'Brick Shooter', 'Tug of War', 'Simon Says']
...
if __name__ == '__main__':
    ...
    # pApp = tictactoeApp()
    apps = {'Painting': paintingApp(), 'tictactoe': tictactoeApp(), 'chess': chessApp(), 'animation': animation_app(), 'Brick Shooter': brick_shooter_app(), 'Simon Says': simonsaysApp(), 'Tug of War': tugofwarApp()}
