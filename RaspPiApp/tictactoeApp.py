...
class tictactoeApp:
    ...
    def paint(self, x, y):
        ...
        if (self.currentPlayer == 'X'):
            ...
            self.touchGrid[self.convert((gameX*4+2), (gameY*4+3))] = (0, 255, 255)
            self.touchGrid[self.convert((gameX*4+1), (gameY*4+4))] = (0, 255, 255)
            self.touchGrid[self.convert((gameX*4+3), (gameY*4+4))] = (0, 255, 255)
            self.touchGrid[self.convert((gameX*4+2), (gameY*4+5))] = (0, 255, 255)
